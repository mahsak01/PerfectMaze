...
public class Process {
    ...
    public static ArrayList<Integer> selectDirection;


    public static void process(Stage primaryStage, int height, int width, LoadingScreen loadingScreen) {
        loadingScreen.showLoading(primaryStage);

        Thread thread = new Thread(() -> {
            selectDirection = new ArrayList<>();
            ...
            Platform.runLater(() -> new ShowMaze().show(primaryStage, loadingScreen));
        });
